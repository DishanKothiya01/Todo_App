...
class CircularLoader extends StatelessWidget {
  ...
  StatefulWidget getLoader(Color? color, BuildContext context) {
    if (Platform.isIOS) {
      return CupertinoActivityIndicator(color: color ?? customColors(context).kPrimaryColor);
    } else {
      return CircularProgressIndicator(color: color ?? customColors(context).kPrimaryColor, strokeWidth: 3);
    }
  }
}
